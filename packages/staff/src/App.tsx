  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center overflow-hidden relative" style={{
        ...
        {/* Text */}
        <div className="relative mt-8 flex flex-col items-center px-5 text-center" style={{
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
            OHCS <span style={{ color: '#D4A017' }}>ClockIn</span>
          </h1>
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <p className="text-[12px] sm:text-[13px] tracking-[0.25em] uppercase font-semibold" style={{ color: '#D4A017' }}>
          ...
          {/* Subtitle */}
          <p className="text-white/30 text-[13px] sm:text-[15px] mt-3">Office of the Head of the Civil Service, Ghana</p>
        </div>
