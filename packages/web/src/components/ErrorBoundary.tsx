...
// App-wide error boundary. A render-time crash in any route (kiosk especially)
// must NOT leave a white screen — we surface a friendly recovery card with a
// reload action instead. Class component because error boundaries require the
